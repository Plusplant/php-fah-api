...
class OrdersApi
{
     ...
     */
    public function create($apitoken, $type, $body)
    {
        list($response) = $this->createWithHttpInfo($apitoken, $type, $body);
        return $response;
    }
     ...
     */
    public function createWithHttpInfo($apitoken, $type, $body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->createRequest($apitoken, $type, $body);
     ...
     */
    public function createAsync($apitoken, $type, $body)
    {
        return $this->createAsyncWithHttpInfo($apitoken, $type, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($apitoken, $type, $body)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2002';
        $request = $this->createRequest($apitoken, $type, $body);
     ...
     */
    protected function createRequest($apitoken, $type, $body)
    {
        // verify the required parameter 'apitoken' is set
        if ($apitoken === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apitoken when calling create'
            );
        }
